...
function App() {
  ...
  <h2 className="subtitle">Regra 2: Cadastro e Informações de Veículos</h2>
  <p className="text">
  ...
  <h2 className="subtitle">Regra 3: Transações Seguras</h2>
  <p className="text">
  ...
  <h2 className="subtitle">Regra 4: Política de Devolução e Cancelamento</h2>
  <p className="text">
  ...
  <h2 className="subtitle">Regra 5: Suporte ao Cliente</h2>
  <p className="text">
  ...
  <h2 className="subtitle">Regra 6: Privacidade e Proteção de Dados</h2>
  <p className="text">
  ...
  <h2 className="subtitle">Regra 7: Conduta e Comportamento dos Usuários</h2>
  <p className="text">
  ...
  <h2 className="subtitle">Regra 8: Responsabilidade dos Anúncios</h2>
  <p className="text">
  ...
  <h2 className="subtitle">Regra 9: Alterações e Atualizações</h2>
  <p className="text">
  ...
  <h2 className="subtitle">Regra 10: Propriedade Intelectual</h2>
  <p className="text">
    Todo o conteúdo disponível no site, incluindo textos, imagens e gráficos, é protegido por direitos autorais e outras leis de propriedade intelectual. Nenhum material do site pode ser copiado, reproduzido ou distribuído sem a devida autorização.
      ...
      <footer className="footer">
        <p className="footer-text">© 2024 - Todos os direitos reservados</p>
      </footer>
    </div>
  );
}
